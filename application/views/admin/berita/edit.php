            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="<?= base_url() ?>berita/update" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <img src="<?= base_url('assets/') ?>img/berita/<?= $berita['image']; ?>" style="width: 120px;margin-bottom: 10px;margin-top: 20px;">
                                        </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea class="ckeditor" id="ckedtor" name="isi"><?= $berita['isi']; ?></textarea>
