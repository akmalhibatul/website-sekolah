            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="<?= base_url() ?>guru/update" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea class="form-control" name="alamat_guru"><?= $guru['alamat_guru']; ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="pelajaran" class="custom-select">
                                            <?php foreach ($pelajaran as $p) : ?>
                                                <?php if ($p['nama_pelajaran'] == $guru['pelajaran']) : ?>
                                                    <option value="<?= $p['nama_pelajaran']; ?>" selected><?= $p['nama_pelajaran']; ?></option>
                                                <?php else : ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kelas" class="custom-select">
                                            <?php foreach ($kelas as $k) : ?>
                                                <?php if ($k['nama_kelas'] == $guru['kelas']) : ?>
